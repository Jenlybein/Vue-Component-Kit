...
const { headLevel, headClass } = defineProps<{ headLevel: number, headClass:string }>();
...
function getArticleOutline() {
    const selectors = ['h1.'+headClass, 'h2.'+headClass, 'h3.'+headClass, 'h4.'+headClass, 'h5.'+headClass, 'h6.'+headClass,];
